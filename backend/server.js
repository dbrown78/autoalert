...
const CORS_ORIGINS = [
  'http://localhost:8081',
  'http://localhost:3001',
  /^exp:\/\//,                  // any Expo Go URL (regex — covers all LAN IPs)
  'https://odin-backend-production-3220.up.railway.app',
  process.env.WEB_CLIENT_URL,  // escape hatch for future web client
].filter(Boolean);             // drop undefined if WEB_CLIENT_URL not set
