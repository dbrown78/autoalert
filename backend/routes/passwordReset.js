...
router.post('/forgot-password', forgotLimiter, async (req, res) => {
    ...
    const generic = { message: 'If an account exists for that email, a reset code has been sent.' };
      ...
      try {
              ...
              logEmailError('forgot-password/sendEmail', emailErr);
              return res.status(502).json({
                        error: 'Reset code generated but email could not be sent. Please check your email configuration and try again.',
              });
      }
