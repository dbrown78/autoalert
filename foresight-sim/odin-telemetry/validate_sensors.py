...
First thing Claude Code runs to confirm the layer is healthy.
"""
...
import numpy as np
from core.specs import SENSOR_REGISTRY, summary_table, sensors_due_at_tick
...
def main():
    ...
    from core.specs import SENSOR_NAMES, get_sensor
